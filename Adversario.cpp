...
void Adversario::mover(Graphics^ g, Bitmap^ img_adversario_tipo1, int contador_timer) {

	w = img_adversario_tipo1->Width / 4;
	h = img_adversario_tipo1->Height / 4;

	pos_x += w; pos_y += h;
	caminar_desde_hasta(posicion, posicion_destino, g, img_adversario_tipo1, contador_timer);
}
									...
									Graphics^ g, Bitmap^ img_adversario_tipo1, int contador_timer)
{
	...
	*/
			...
			if (pos_y < 300) {
				...
				if (animacion == 4) {
					...
					if (tipo == 1) posicion_destino = "A"; //Si es tipo 1 que vuelva a A
						...
						{
							case 0: { posicion_destino = "C"; break; }
							case 1: { posicion_destino = "C"; break; }
							case 2: { posicion_destino = "C"; break; }
							default: break;
						}
	...
	//Listo
	else if (posicion == "B" && posicion_destino == "A") {//Camino 1
